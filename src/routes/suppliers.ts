...
router.get("/:id", authenticate, authorize("admin"), (_req: Request, res: Response) => {
  res.status(200).json({ message: "TODO: Get supplier profile by ID" });
});

router.put("/:id", authenticate, authorize("admin"), (_req: Request, res: Response) => {
  res.status(200).json({ message: "TODO: Update supplier profile" });
});

router.get("/:id/products", authenticate, authorize("admin"), (_req: Request, res: Response) => {
  res.status(200).json({ message: "TODO: List products by supplier" });
});

router.get("/:id/orders", authenticate, authorize("admin"), (_req: Request, res: Response) => {
  res.status(200).json({ message: "TODO: List orders for a supplier" });
});

router.get("/:id/analytics", authenticate, authorize("admin"), (_req: Request, res: Response) => {
